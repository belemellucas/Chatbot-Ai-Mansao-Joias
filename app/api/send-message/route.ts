...
export async function POST(req: NextRequest) {
   ...
   try {
     ...
     const formattedPreviousMessages: ChatCompletionMessageParam[] = 
       ...
       // combine characteristics into a system promp
       ...
       const systemPrompt = chatbot.chatbot_characteristics
        ...
        const messages: ChatCompletionMessageParam[] = [
            {
                ...
                relavant or in the same scope or domain as the points in mentioned in the key information section, kenfly
                inform the user theyre only allowed to search for the specified content. Use Emoji's where possible. Here
                is some key information that you nedd to be aware of, these are elements you may be asked about: 
                ${systemPrompt}`
            },
        ...
        // Step 6: Return the AI's response to client
        return NextResponse.json({
