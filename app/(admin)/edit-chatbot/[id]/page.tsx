  ...
  const handleAddCharacteristic = async (content: string) => {
    try {
      ...
      toast.promise(promise, {
        ...
        error: "Falha ao adicionar informações",
      });
    } catch (err) {
  ...
  const handleUpdateChatbot = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast.promise(promise, {
        ...
        error: "Failed to updated chatbot",
      });
    } catch (err) {
    ...
    <div className="px-0 md:p-10">
      ...
      <section className="relative mt-5 bg-white p-5 md:p-10 rounded-lg">
        ...
        <h2 className="text-xl font-bold mt-10">
          {" "}
          Aqui está o que sua AI sabe...
        </h2>
        <p>
        Seu chatbot está equipado com as seguintes informações para ajudá-lo
        em suas conversas com seus clientes e usuários
        </p>
